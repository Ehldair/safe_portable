...
if(isset($_GET['id_usuario'])) {
    $myid_usuario = mysqli_real_escape_string($link,$_GET['id_usuario']);
}
					...
					<div class="box">
						...
						<div class="col-12">
							<ul class="actions special">
								...
								<li><input type="button" onclick="location.href='modificarusuario.php';" value="Volver" class="estilo"></li>							
							</ul>
						</div>
