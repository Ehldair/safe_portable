    		...
    		function validar() {
    			...
    			$.ajax({
    				...
    				success: function(respuesta) {
    					if(respuesta==1) {
    						window.location="gestion_grupo.php";
    					}
    					else {
    					...
    					<div class="box">
    						<form method="post" id="myform" action="javascript:validar();">
    							...
    							<div class="row gtr-50 gtr-uniform">
    								...
    								echo "<div class='col-6 col-12-mobilep'>";
    								echo " Grupo:";
    								echo "<input type='text' name='grupo' id='grupo' required placeholder='Grupo' />";
    								echo "</div>";
    								
    								//Input para el movil
    								echo "<div class='col-4 col-12-mobilep'>";
    								echo " Móvil:";
    								echo "<input type='text' name='movil' id='movil' placeholder='Móvil' />";
    								echo "</div>";
    								...
    								//Input para el responsable
    								echo "<div class='col-4 col-12-mobilep'>";
    								echo " Responsable:";
    								echo "<input type='text' name='responsable' id='responsable' placeholder='Responsable' />";
    								echo "</div>";
    								?>
    						...
    						<div class="col-12">
    							<ul class="actions special">
    								<li><input type="submit" id="alta" value="Alta Grupo"/></li>	
