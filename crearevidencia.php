...
if($mod!="1") {
    ...
    $myobservaciones=str_replace("\\r",".",$myobservaciones);
    $myobservaciones=str_replace("\\n"," ",$myobservaciones); 
    ...
    if($count!=0) {
       echo "Ya existe esa evidencia ";
        ...
        $myid_evidencia=$ret['id'];
         ...
         $sql="INSERT INTO evidencia_registro(id_evidencia,id_estado_evidencia,id_usuario,fecha_alta_estado) VALUES ($myid_evidencia, 1, $myid_u, '$myfecha')";
         mysqli_query($link,$sql);
