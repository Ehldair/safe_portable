...
if(isset($_SESSION['id_u'])) {
    ...
    $myintervencion=$_POST['intervencion'];    
    		...
    		function validar() {
    			...
    			$.ajax({
    				...
    				success: function(respuesta) {
    					if(respuesta==1) {
    						window.location="detalle_intervencion.php";
    					}
    					else {
    					...
    					<div class="box">
    						<form method="post" id="myform" action="javascript:validar();">
    							...
    							<div class="row gtr-50 gtr-uniform">
    								...
    								<div class="col-3 col-12-mobilep">								
                                        ...
                                        from usuario u
                                        INNER JOIN equipo_intervencion eq ON eq.id_usuario=u.id_usuario
                                        where id_intervencion=$myintervencion");
    						...
    						<div class="col-12">
    							<ul class="actions special">
    								<li><input type="submit" id="alta" value="Alta Funcionario"/></li>	
