...
<?php 
echo "<br><div class='table-wrapper'><table><thead><tr><th>Caso</th><th>Nombre</th><th>Descripcion</th></tr></thead>";
...
?>
			...
			<div class="col-12">
									<ul class="actions special">
										<li><input type="button" onclick="location.href='inicio.php';" value="Volver" /></li>
									</ul>
								</div>
