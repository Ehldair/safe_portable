...
if(isset($_SESSION['id_u'])) {
    ...
    $sql="select v.id_usuario as id_usuario ,u.apodo as apodo ,COUNT(v.id_usuario) as cuenta from viajes_funcionario v inner join usuario u on u.id_usuario=v.id_usuario WHERE YEAR(fecha_inicio)=YEAR(CURDATE()) 
    ...
    from usuario u
    LEFT JOIN viajes_funcionario v ON v.id_usuario=u.id_usuario and YEAR(fecha_inicio)=YEAR(CURDATE())
    ...
    <div id='div-results'>
    	...
    	<!-- Main -->
    		<section id="main" class="container">
    			<header>
    				<h2> Viajes</h2>
    				<p>Viajes Totales <?php echo date('Y');?></p>
    			</header>			
    			<div class="row">
    						<div class="col-12">
    							<!-- Table -->
