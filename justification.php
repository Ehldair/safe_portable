...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Arial bold 15
        /*$this->SetFont('Arial','B"justification.php"',15);
    ...
    function Footer()
    {
        ...
        $this->Cell(0,5,'xxxxxxxxx@dpg.mir.es',0,0,L);
        ...
        $this->Cell(0,0,'XXXXXXXX GENERAL XXXXXXX',0,2,R);
        $this->Cell(0,5,utf8_decode('C/ JXXXXXXXXXXXXXador s/n'),0,2,R);
        $this->Cell(0,0,'XXXX - MADRID',0,2,R);
